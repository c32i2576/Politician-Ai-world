...
> 對應缺口：[../02-gaps.md §2](../02-gaps.md)
> 取代：[../archive/design-priority-three.md §2](../archive/design-priority-three.md) 的固定長度方案
...
- **可重現性**：給定 seed 和輸入序列，重跑結果一致（[../02-gaps.md §17](../02-gaps.md)）。
...
### 3.1 公式（補 [../01-research.md L411](../01-research.md#L411) 缺的部分）
...
### 5.1 Bill 生命週期對應（已整合進 [bill-model.md](bill-model.md)）
